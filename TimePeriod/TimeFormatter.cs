...
namespace Itenso.TimePeriod
{
	...
	public class TimeFormatter : ITimeFormatter
	{
		...
		{
			return !string.IsNullOrEmpty( dateTimeFormat ) ? dateTime.ToString( dateTimeFormat ) : dateTime.ToString();
		} // GetDateTime

		// ----------------------------------------------------------------------
		public string GetShortDate( DateTime dateTime )
		{
			return !string.IsNullOrEmpty( shortDateFormat ) ? dateTime.ToString( shortDateFormat ) : dateTime.ToShortDateString();
		} // GetShortDate

		// ----------------------------------------------------------------------
		public string GetLongTime( DateTime dateTime )
		{
			return !string.IsNullOrEmpty( longTimeFormat ) ? dateTime.ToString( longTimeFormat ) : dateTime.ToLongTimeString();
		} // GetLongTime

		// ----------------------------------------------------------------------
		public string GetShortTime( DateTime dateTime )
		{
			return !string.IsNullOrEmpty( shortTimeFormat ) ? dateTime.ToString( shortTimeFormat ) : dateTime.ToShortTimeString();
		} // GetShortTime
